...
%global multimc_commit              7450faaf1355af566515b9a156c704c6cd9a21ff
...
Name:           multimc
Version:        0.7.0
Release:        1.git%{multimc_commit}%{?dist}
...
Source0:        https://github.com/MultiMC/Launcher/archive/%{multimc_commit}.tar.gz
...
%prep
%autosetup -p1 -n Launcher-%{multimc_commit}
...
%cmake \
    ...
    -DLauncher_VERSION_BUILD=%{multimc_commit} \
